  ...
  return (
    <div className="p-4 md:p-8 space-y-8">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md">
        <h2 className="text-xl font-bold text-gray-700 mb-4 border-b pb-3">API Configuration</h2>
            ...
            <div className="flex flex-col gap-3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-24"
                />
                <button
